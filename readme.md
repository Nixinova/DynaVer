...
## Backus–Naur form
*[Sandbox](https://tinyurl.com/DynaVerBNF-0-2-1-3)*
```
...
<identifier_characters> ::= ( <integers> | <letters> | "." ) ( <identifier_characters> )?

<metadata_characters> ::= ( <identifier_characters> | "-" | "_" ) ( <metadata_characters> )?
